...
public class MonsterTest {
	...
	public void testMonster() throws Exception {
		...
		this.driver.findElement(By.id("EmailAddress")).sendKeys("kathy.us@aol.com");
		this.driver.findElement(By.id("Password")).clear();
		this.driver.findElement(By.id("Password")).sendKeys("t3stmail");
